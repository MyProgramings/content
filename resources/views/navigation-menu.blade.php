<nav x-data="{ open: false }" class="bg-white  border-bottom border-2">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:mr-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('user_profile')">
                        {{ __('الملف الشخصي') }}
                    </x-nav-link>
                </div>
                @if (Auth::user()->role == 1)
                    <div class="hidden space-x-8 sm:-my-px sm:mr-4 sm:flex">
                    <div class="flex items-center">
